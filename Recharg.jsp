...
%>
								<form action="RechargeSuccess.jsp">
        <table align="center">
        
    <tr><td>Customer Name</td><td><input type="text" name="nm" value="<%=nm%>" readonly=""/></td></tr>
    <tr><td>Recharge Amount</td><td><input type="text" name="amount" required=""/></td></tr>
    <tr><td><input type="submit" value="Recharge"/></td><td><input type="reset" value="Cancel"/></td></tr>
        </table>
        </form>
							</ul>
						</div>
