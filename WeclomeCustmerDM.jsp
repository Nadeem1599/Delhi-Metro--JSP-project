<%-- 
    Document   : WeclomeCustmerDM
    Created on : Mar 21, 2016, 12:40:29 PM
    Author     : hp
--%>
					...
					<div class="content">
						...
						<div class="grid_1_of_4 images_1_of_4 services">
							...
							<ul>
								...
								<li><img src="images/marker2.jpg" title="pointer ">RED LINE METRO</li>
								<li><img src="images/marker2.jpg" title="pointer ">BLUE LINE METRO</li>
								<li><img src="images/marker2.jpg" title="pointer ">GREEN LINE METRO</li>
								<li><img src="images/marker2.jpg" title="pointer ">YELLOW LINE METRO</li>
                                                                <li><img src="images/marker2.jpg" title="pointer ">VOILET LINE METRO</li>
                                                                <li><img src="images/marker2.jpg" title="pointer ">ORRANGE LINE METRO</li>
							</ul>
						</div>
					</div>
